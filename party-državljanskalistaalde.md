...
Last result: **1.1%** (General Election of 25 May 2014)
...
The following table shows the probability mass function per percentage block of voting intentions for the [poll average](average.html) for Državljanska lista (ALDE).
...
The following table shows the probability mass function per seat for the [poll average](average.html) for Državljanska lista (ALDE).
